  ...
  Widget buildItem(BuildContext context, int index) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: widget.itemBuilder(context, data, _contains(data, _subclassIndex), widget.valueKey),
      ),
      onTap: () {
        isRegular = true;
  ...
  void _dealingMultiple(dynamic data) {
    setState(() {
      if (!_contains(data, _subclassIndex)) {
        ///处理多选与单选问题
        if (!_isMultiple || data[widget.keyWords] == _selectedIndex[widget.keyWords]) {
...
//                                    });
                          ...
                          Container(
                            ...
                            child: const Text(
                              "至",
                              style: TextStyle(color: Color(0XFF606266), fontSize: 15.0),
                            ),
                          ),
                          Expanded(
                              child: Container(
